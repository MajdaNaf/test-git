...
public class Rule {
  ...
  boolean fired=false; //when a rule is chosen to be developed
...
//those clauses
void fire() {
RuleBase.appendText("\nDéveloppement de la règle " + name ) ;
